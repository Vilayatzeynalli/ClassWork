...
// console.log(countries_data.sort((a,b) =>b.name-a.name.localeCompare(a.name)));
...
////////////
// console.log(countries_data.filter(element=>element.languages.includes("English")));

// ///////////
// console.log(countries_data.filter(element => element.region==="Europe" || element.region==="Asia"));

// ///////////
// console.log(countries_data.filter(element=>element.languages.length>1));

// ///////////
// console.log(countries_data.map(element=>`${element.capital}, ${element.name}`));
